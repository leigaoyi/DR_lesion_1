...
from utils.attention_module import cbam_block
...
def get_SCUNet(patch_height, patch_width, channels, n_classes):
    """
    It creates a U-Net and returns the model
    :param patch_height: height of the input images
    :param patch_width: width of the input images
...
#===================================================================
#========================S+C_UNet_V1 =================================
# Use the different spatial attention module from the one in the BAM article.
    

def get_SE_UNet(patch_height, patch_width, channels, n_classes):
    """
    It creates a U-Net and returns the model
    :param patch_height: height of the input images
    :param patch_width: width of the input images
...
def get_CBAM_UNet(patch_height, patch_width, channels, n_classes):
    """
    It creates a U-Net and returns the model
    :param patch_height: height of the input images
    :param patch_width: width of the input images
...
def get_CBAM_UNet_v2(patch_height, patch_width, channels, n_classes):
    """
    It creates a U-Net and returns the model
    :param patch_height: height of the input images
    :param patch_width: width of the input images
